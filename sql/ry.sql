...
CREATE TABLE `hihatu_worktbl` (
  ...
  `extra` varchar(45) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`hid`)
) ENGINE=InnoDB AUTO_INCREMENT=1002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='通勤表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=376 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,103,'admin','若依','00','ry@163.com','15888888888','1','','29c67a30398638269fe600f73a054934','111111','0','0','127.0.0.1','2022-10-30 09:42:52','2022-07-30 14:32:30','admin','2022-07-30 14:32:30','','2022-10-30 10:42:51','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','8e6d98b90472783cc73c17047ddccf36','222222','0','0','127.0.0.1','2022-07-30 14:32:30','2022-07-30 14:32:30','admin','2022-07-30 14:32:30','',NULL,'测试员');
...
-- Dump completed on 2022-10-30 11:10:59
